...
export namespace cave
{
	...
	public:
		 ...
		 *
		 */
		constexpr bool RemoveAt(size_t index, size_t count = NPOS)
		{
		...
		String& Replace(size_t pos, size_t count, const String& str, size_t pos2, size_t count2 = NPOS)
		{
			...
			strncpy_s(&mString[pos], mCapacity - pos, &str.mString[pos2], count2);
		 ...
		 *
		 */
		String GetSubstring(size_t pos, size_t count = NPOS) const
		{
			assert(pos <= mLength);

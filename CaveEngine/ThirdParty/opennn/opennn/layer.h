...
public:
    ...
    virtual string write_expression(const Tensor<string, 1>& inputs_names, const Tensor<string, 1>& outputs_names) const
	{
		assert(inputs_names.size() >= 0);
		assert(outputs_names.size() >= 0);
		return string();
	}

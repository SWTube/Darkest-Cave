...
export module DdsTextureLoader;
...
namespace cave
{
    ...
    #define DDS_ALPHA_MODE_DEFINED
		export enum DDS_ALPHA_MODE : uint32_t
		{
            ...
            size_t* bitSize) noexcept
        {
            ...
            const DDS_HEADER* hdr = reinterpret_cast<const DDS_HEADER*>(ddsData + sizeof(uint32_t));
...
#undef ISBITMASK
			...
			_Out_opt_ DDS_ALPHA_MODE* alphaMode) noexcept
        {
            ...
            std::unique_ptr<uint8_t[]> ddsData;
            HRESULT hr = LoadTextureDataFromFile(szFileName,
                ddsData,
                &header,
                &bitData,
                &bitSize
            ...
            if (SUCCEEDED(hr))
            {
                SetDebugTextureInfo(szFileName, texture, textureView);

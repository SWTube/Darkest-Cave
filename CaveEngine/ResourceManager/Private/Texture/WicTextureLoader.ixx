...
export module WicTextureLoader;
...
#define WIC_LOADER_FLAGS_DEFINED
        export enum WIC_LOADER_FLAGS : uint32_t
        {
        ...
        _Use_decl_annotations_
            export HRESULT CreateWICTextureFromMemory(
        ...
        _Use_decl_annotations_
            export HRESULT CreateWICTextureFromMemoryEx(
                ID3D11Device* d3dDevice,
                const uint8_t* wicData,
                size_t wicDataSize,
                size_t maxsize,
        ...
        //--------------------------------------------------------------------------------------
        _Use_decl_annotations_
            export HRESULT CreateWICTextureFromFile(
                ID3D11Device* d3dDevice,
        ...
        _Use_decl_annotations_
            export HRESULT CreateWICTextureFromFileEx(
                ID3D11Device* d3dDevice,
                const wchar_t* fileName,
                size_t maxsize,
                D3D11_USAGE usage,
